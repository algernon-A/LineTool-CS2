...
namespace LineTool
{
    ...
    public sealed partial class LineToolUISystem : UISystemBase
    {
        ...
        protected override void OnCreate()
        {
            ...
            // Read injection data.
            _commonJS = ReadJS("LineTool.UI.common.js");
            _modeHTML = ReadHTML("LineTool.UI.modes.html", "modeDiv", "if (!document.getElementById(\"line-tool-modes\") && !document.getElementById(\"line-tool-panel\")) { lineTool.modeParent = document.getElementsByClassName(\"tool-options-panel_Se6\"); if (lineTool.modeParent.length != 0) lineTool.modeParent[0].appendChild(lineTool.modeDiv); }");
            _modeJS = ReadJS("LineTool.UI.modes.js");
            _injectedHTML = ReadHTML("LineTool.UI.ui.html", "div", "lineTool.div.className = \"tool-options-panel_Se6\"; lineTool.div.id = \"line-tool-panel\"; lineTool.targetParent = document.getElementsByClassName(\"tool-side-column_l9i\"); if (lineTool.targetParent.length == 0) lineTool.targetParent = document.getElementsByClassName(\"main_k4u\"); if (lineTool.targetParent.length != 0) lineTool.targetParent[0].appendChild(lineTool.div);");
